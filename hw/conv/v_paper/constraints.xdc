create_clock -period 4 -name clk -waveform {0.000 2.000} [get_ports clk]
...
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[24].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[25].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[26].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[27].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[28].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[29].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[30].dut"}]
# add_cells_to_pblock [get_pblocks pblock_clustered_logic] [get_cells -hierarchical -filter {NAME =~ "*name[31].dut"}]
