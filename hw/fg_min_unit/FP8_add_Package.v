...
module FP8_add_Top(
    ...
    (* dont_touch = "true" *)unpack u_unpack(
        .a        (a        ),
        .b        (b        ),
        .signed_a (signed_a ),
        .signed_b (signed_b ),
    ...
    (* dont_touch = "true" *)exp_compare u_exp_compare(
        .exp_a         (exp_a         ),
        .exp_b         (exp_b         ),
    ...
    (* dont_touch = "true" *)exp_diff u_exp_diff(
        .exp_a        (exp_a        ),
        .exp_b        (exp_b        ),
    ...
    (* dont_touch = "true" *)signed_xor u_signed_xor(
        .signed_a   (signed_a   ),
        .signed_b   (signed_b   ),
    ...
    (* dont_touch = "true" *)shifter u_shifter(
        .exp_diff      (exp_diff      ),
        .signed_a      (signed_a      ),
        .signed_b      (signed_b      ),
        .signed_xor    (signed_xor    ),
