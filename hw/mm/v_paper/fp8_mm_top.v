...
// mat-vec blocks
(* keep_hierarchy = "yes", dont_touch = "true" *)fp8_mm #(
	 .A_W (A_W)
	,.M_W (M_W)
	,.D_W (D_W)
	,.URAM_D_W (URAM_D_W)
...
(* keep_hierarchy = "yes", dont_touch = "true" *) fp8_mm #(
	...
	,.URAM_A_W (URAM_A_W)
        ...
        ,.SELF_ADDR_A (11'h1),.EXP_WIDTH(EXP_WIDTH),
            .MANT_WIDTH(MANT_WIDTH)
)
mm2 (
         .clk           (clk)
...
(* keep_hierarchy = "yes", dont_touch = "true" *) fp8_mm #(
	...
	,.URAM_A_W (URAM_A_W)
        ,.NUMBER_OF_REG (NUMBER_OF_REG)
        ,.CASCADE_ORDER_A ("MIDDLE")
        ,.SELF_ADDR_A (11'h2),.EXP_WIDTH(EXP_WIDTH),
            .MANT_WIDTH(MANT_WIDTH)
)
mm3 (
         .clk           (clk)
...
(* keep_hierarchy = "yes", dont_touch = "true" *) fp8_mm #(
	...
	,.URAM_A_W (URAM_A_W)
        ...
        ,.SELF_ADDR_A (11'h3),.EXP_WIDTH(EXP_WIDTH),
            .MANT_WIDTH(MANT_WIDTH)
)
mm4 (
         .clk           (clk)
